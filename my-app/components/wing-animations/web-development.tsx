...
export function WebDevelopmentAnimation() {
  ...
  return (
    ...
    >
      <div
        className={`relative w-full h-full flex flex-col justify-center  mx-auto transition-transform duration-300 ${
      ...
      >
        ...
        {/* Browser Content */}
        <div className="bg-slate-900/90 rounded-b-xl min-h-[120px] relative overflow-hidden">
          {/* Loading Bar */}
          ...
          <div className="p-2 space-y-1.5">
            ...
            {/* Preview Boxes */}
            <div
              className={`grid grid-cols-3 gap-1 transition-all duration-500 delay-200 ${
                showContent
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 -translate-y-4"
              }`}
